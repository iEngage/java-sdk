...
import com.iengage.auth.HttpBasicAuth;
import com.iengage.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.iengage.io:8243/api/1.0";
    ...
    public ApiClient() {
        ...
        setUserAgent("iEngage-SDK/1.0.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.iengage.io:8243/api/1.0
    ...
    public Call buildCall(String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    	if(authNames==null || (authNames!=null && authNames.length==0)){
    		authNames = new String[] { "default" };
    	}    	
    ...
    public void processHeaderParams(Map<String, String> headerParams, Request.Builder reqBuilder) {
        for (Entry<String, String> param : headerParams.entrySet()) {
        	System.out.println(">>>>>>>>param.getKey()"+param.getKey()+">>>>>"+parameterToString(param.getValue()));
            reqBuilder.header(param.getKey(), parameterToString(param.getValue()));
        }
        for (Entry<String, String> header : defaultHeaderMap.entrySet()) {
        	System.out.println(">>>>>>>>header.getKey()"+header.getKey()+">>>>>"+parameterToString(header.getValue()));
